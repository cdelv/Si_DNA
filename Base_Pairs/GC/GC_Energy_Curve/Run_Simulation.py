...
def main():
    ...
    df = pd.DataFrame(columns=["directory","distance","energy"])
    ...
    base_distance = min(Meassure_Distance(atomic_coordinates, 22, 10), Meassure_Distance(atomic_coordinates, 20, 8), Meassure_Distance(atomic_coordinates, 25, 12))
    ...
    for distance in distances:
        ...
        df.loc[len(df.index)] = [directory, Meassure_Distance(atomic_coordinates, 22, 10), energy]
